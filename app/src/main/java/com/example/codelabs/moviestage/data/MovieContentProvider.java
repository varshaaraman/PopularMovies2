...
public class MovieContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         */
        uriMatcher.addURI(MovieContract.CONTENT_AUTHORITY, MovieContract.PATH_POPULARMOVIES, MOVIES);
        uriMatcher.addURI(MovieContract.CONTENT_AUTHORITY, MovieContract.PATH_POPULARMOVIES + "/#", MOVIES_WITH_ID);
